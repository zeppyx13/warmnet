   ...
   <body class="main-layout">
      ...
      <header>
         ...
         <div class="header">
            <div class="container-fluid">
               <div class="row">
                  <div class="col-lg-2 col-md-2 col-sm-2 col logo_section">
                     <div class="full">
                     ...
                     <nav class="navigation navbar navbar-expand-md navbar-dark ">
                        ...
                        <div class="collapse navbar-collapse" id="navbarsExample04">
                           <ul class="navbar-nav mr-auto">
                              ...
                              <li class="nav-item">
                                 <a class="nav-link" href="computer.html">Diskon</a>
                              </li>
                              <li class="nav-item">
      ...
      <div class="customer">
         <div class="container">
            <div class="row">
               <div class="col-md-12">
                  <div class="titlepage" data-aos="zoom-in-up">
                     <h2>Testimonial kami</h2>
                  </div>
               </div>
            </div>
            <div class="row">
                              ...
                              <div class="carousel-caption ">
                                 <div class="row">
                                    <div class="col-md-9 offset-md-3">
                                       <div class="test_box">
                                          <i><img src="landing/images/cos.png" alt="#"/></i>
                                          <h4>Wayan Doblar </h4>
                                          <p>Memuaskan🥰</p>
                                       </div>
                                    </div>
                                 ...
                                 <div class="row">
                                    <div class="col-md-9 offset-md-3">
                                       <div class="test_box">
                                          <i><img src="landing/images/cos.png" alt="#"/></i>
                                          <h4>Sandy Miller</h4>
                                          <p>Pelayanan nya sangat baik dan menyenangkan😁</p>
                                       </div>
                                    </div>
                                 </div>
                              </div>
         ...
         <div class="footer">
            <div class="container">
               <div class="row">
                  <div class="col-xl-3 col-lg-3 col-md-6 col-sm-6">
                     <img class="logo1" src="landing/images/Picsart_22-04-21_10-37-33-304.png" alt="#"/>
            ...
            <div class="copyright">
               <div class="container">
                  <div class="row">
                     <div class="col-md-12">
                        <p>© 2022 All Rights Reserved. Design by Dede Gacorr</p>
                     </div>
                  </div>
               </div>
            </div>
